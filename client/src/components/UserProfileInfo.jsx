  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="w-full mt:pt-0 md:pl-36">
                <div className="flex flex-col md:flex-row items-start justify-between">
                    ...
                    {/* IF user is on his own profile than we will show edit buttom */}
                    {
                        !profileId && 
                            <button className='flex items-center gap-2 border border-gray-300 hover:border-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer' onClick={() => setShowEdit(true)}>
