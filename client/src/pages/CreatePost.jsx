    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
          ...
          {/* Text Area */}
            <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' onChange={(e) => setContent(e.target.value)} value={content} placeholder="What's happening?" />
          ...
          {/* Images */}
            ...
            {/* Bottom Bar */}
              <div className="flex items-center justify-between pt-3 border-t border-gray-300">
                ...
                )} className='py-2 px-8 text-sm rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-800 active:scale-95 text-white transition cursor-pointer' to='/create-post'>Publish Post</button>
              </div>
        </div>
      </div>
    </div>
