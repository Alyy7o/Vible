...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      ...
      {/* Input message */}
      <div className="px-4">
        <div className="flex items-center gap-3 p-1.5 pl-5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
          ...
          <button onClick={sendMessage} className='bg-gradient-to-r from-indigo-500 to-purple-600 hover:form-indigo-700 hover:to-purple-800 active:scale-95 text-white cursor-pointer p-2 rounded-full'>
